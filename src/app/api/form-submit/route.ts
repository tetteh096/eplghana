...
import { FORM_SUBMISSION_TYPES, resolveSourcePage, resolveSourcePath } from '@/lib/formSubmissionMeta'
import { recordFormSubmission } from '@/lib/recordFormSubmission'
...
export async function POST(request: Request) {
  ...
  if (!FORM_SUBMISSION_TYPES.has(formType)) {
  ...
  const sourcePage = resolveSourcePage(body.sourcePage, body.sourcePath)
  const sourcePath = resolveSourcePath(body.sourcePath)
