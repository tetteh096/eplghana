...
export const peaceContent = {
  ...
  keySuccess: {
    ...
    title: 'Strategic Peace Building Initiatives',
    stories: [
      {
  ...
  partnerCta: {
    ...
    description:
      'Collaborate with EPL Ghana and the U.S. Embassy in Ghana to foster peacebuilding and civic security.',
    ctaLabel: 'Contact Us',
    ctaHref: '/contact',
    image: `${EPL_MEDIA}/2025/10/Meeting-with-Deputy-Regional-Commander-2-1024x768.jpeg`,
  },
