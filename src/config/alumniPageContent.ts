...
export const alumniPageContent = {
  hero: {
    ...
    secondaryCta: { label: 'Sponsor EPLAN', href: '/donate' },
  },
  sustain: {
    eyebrow: 'Beyond the Fellowship',
    title: 'Sustaining Impact Throughout a Public Service Career',
    lead:
    ...
    imageAlt: 'EPLAN members at a fellows convening',
    pillarsEyebrow: 'How EPLAN Sustains Leaders',
    pillars: [
      {
        num: '01',
        title: 'Lifelong Professional Development',
        description:
          'Continuous executive masterclasses, public policy certificates, and specialized governance workshops tailored for mid-career civil servants.',
      },
      {
        num: '02',
        title: 'Alumni-to-Fellow Mentorship',
        description:
          'Graduated Fellows give back by mentoring incoming cohorts, sharing practical institutional navigation tactics, and providing placement guidance.',
      },
      {
        num: '03',
        title: 'Cross-Sector Working Groups',
        description:
          'Alumni collaborate across health, finance, agriculture, and local government to co-author policy briefs and solve inter-agency bottlenecks.',
      },
      {
        num: '04',
        title: 'Regional & Institutional Chapters',
        description:
          'Decentralized alumni chapters operating across regional assemblies and key ministries in Accra, Kumasi, Tamale, and Sekondi-Takoradi.',
      },
    ],
  },
  spotlight: {
    eyebrow: 'Network Spotlight',
    title: 'Recent Highlights & Success Stories',
    intro:
