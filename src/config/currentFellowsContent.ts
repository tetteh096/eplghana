...
export const currentFellowsPageContent = {
  ...
  directory: {
    ...
    sectorFilterLabel: 'Filter by Sector',
    defaultRoleLabel: 'Public Service Fellow',
    initialVisibleCount: 8,
    showMoreLabel: 'Show More Fellows',
  ...
  involve: {
    ...
    title: 'Join Us in Building Change Agents',
    body: 'We invite you to join us; to support our efforts by donating, or collaborating on exciting projects building change agents in our communities and countries.',
