          ...
          fields: [
            {
              name: 'curveEyebrow',
              type: 'text',
              defaultValue: defaultHeroCurve.eyebrow,
            },
            {
              name: 'curveTitle',
              type: 'text',
              defaultValue: defaultHeroCurve.title,
            },
            {
              name: 'curveDescription',
              type: 'textarea',
              defaultValue: defaultHeroCurve.description,
            },
            {
              name: 'curveCtaLabel',
              type: 'text',
              defaultValue: defaultHeroCurve.ctaLabel,
            },
            {
              name: 'curveCtaUrl',
              type: 'text',
              defaultValue: defaultHeroCurve.ctaUrl,
            },
          ],
        },
        {
          ...
          fields: [
            {
              ...
              fields: [
                ...
                },
                {
                  ...
                  relationTo: 'media',
                  admin: {
                    description: 'Card photo. Leave empty to keep the current image.',
                  },
                },
                {
                  name: 'href',
        ...
        },
        {
          ...
          fields: [
            ...
            },
            {
              ...
              type: 'text',
              defaultValue: 'Meet more fellows',
            },
            {
              name: 'impactStoriesCtaUrl',
              type: 'text',
              defaultValue: '/community/current-fellows',
            },
            {
              name: 'impactStories',
              type: 'array',
      ...
      fields: [
        {
          ...
          label: 'Intro',
          fields: [
            { name: 'introEyebrow', type: 'text', defaultValue: 'About EPL Ghana' },
            { name: 'introTitle', type: 'text', defaultValue: 'Who We Are' },
            {
              name: 'introLead',
              type: 'textarea',
              defaultValue:
        ...
        },
        {
          ...
          fields: [
            ...
            { name: 'growthHighlightLabel', type: 'text' },
            {
              name: 'growthTitle',
              type: 'text',
              defaultValue: 'A Movement for Stronger Public Service',
            },
            {
              name: 'growthBody',
              type: 'textarea',
        ...
        },
        {
          ...
          label: 'Mission tab',
          fields: [
            { name: 'eyebrow', type: 'text', defaultValue: 'Mission' },
            { name: 'title', type: 'text', defaultValue: 'What We Do' },
            {
              name: 'body',
              type: 'textarea',
              defaultValue:
                "To develop ethical, critical-thinking and change-driven public sector leaders who strengthen Ghana's institutions and serve the public good.",
            },
            { name: 'image', type: 'upload', relationTo: 'media' },
          ],
        },
        {
          ...
          label: 'Vision tab',
          fields: [
            { name: 'eyebrow', type: 'text', defaultValue: 'Vision' },
            { name: 'title', type: 'text', defaultValue: 'Where We Are Going' },
            {
              name: 'body',
              type: 'textarea',
              defaultValue:
                'A Ghana where public institutions are led by principled, capable and innovative leaders committed to national development and public welfare.',
            },
            { name: 'image', type: 'upload', relationTo: 'media' },
          ],
        },
          ...
          fields: [
            {
              ...
              fields: [
                ...
                { name: 'meaning', type: 'textarea', required: true },
                {
                  ...
                  admin: {
                    description: 'Flip-card face colour. Defaults to blue if unset.',
                  },
                },
              ],
            },
      ...
      fields: [
        {
          ...
          label: 'Hero',
          fields: [
            { name: 'heroEyebrow', type: 'text', defaultValue: 'The EPL Ghana Community' },
            {
              name: 'heroTitle',
              type: 'text',
              defaultValue: 'Current Cohort & Network',
            },
            {
              name: 'heroLead',
              type: 'textarea',
        ...
        },
        {
          ...
          admin: {
            description:
              'Search and labels for the fellow grid. Cohort filter tabs come from the Cohorts collection (published + “Show on website”).',
          },
          fields: [
            {
              name: 'defaultCohort',
              ...
              admin: {
                readOnly: true,
                description: 'Set automatically from the cohort marked “Default tab on website” in Cohorts.',
              },
            },
            {
              name: 'cohortTabs',
              type: 'array',
              labels: { singular: 'Tab', plural: 'Cohort tabs' },
              admin: {
                readOnly: true,
                description: 'Legacy fallback only. Tabs are loaded from the Cohorts collection when published.',
              },
              fields: [
                { name: 'label', type: 'text', required: true },
                { name: 'value', type: 'text', required: true },
            ...
            },
            {
              ...
              type: 'text',
              defaultValue: 'Search by name, role, or institution...',
            },
            { name: 'sectorFilterLabel', type: 'text', defaultValue: 'Filter by Sector' },
            { name: 'defaultRoleLabel', type: 'text', defaultValue: 'Public Service Fellow' },
            { name: 'initialVisibleCount', type: 'number', defaultValue: 8 },
            { name: 'showMoreLabel', type: 'text', defaultValue: 'Show More Fellows' },
            { name: 'showLessLabel', type: 'text', defaultValue: 'Show Less' },
            {
              name: 'emptyStateText',
              type: 'text',
              defaultValue: 'No fellows match your search criteria.',
            },
          ],
        },
        {
        ...
        },
        {
          ...
          label: 'EPLAN promo',
          fields: [
            { name: 'eplanEyebrow', type: 'text', defaultValue: 'Lifelong Leadership' },
            {
              name: 'eplanTitle',
              type: 'text',
              defaultValue: 'Emerging Public Leaders Alumni Network (EPLAN)',
            },
            {
              name: 'eplanIntro',
              type: 'textarea',
            ...
            { name: 'eplanCtaLabel', type: 'text', defaultValue: 'Explore EPLAN Hub' },
            { name: 'eplanCtaUrl', type: 'text', defaultValue: '/community/eplan' },
          ],
        },
        {
          type: 'collapsible',
          label: 'Get Involved',
          fields: [
            { name: 'involveEyebrow', type: 'text', defaultValue: 'Get Involved' },
            {
              name: 'involveTitle',
              type: 'text',
              defaultValue: 'Join Us in Building Change Agents',
            },
            {
              name: 'involveBody',
              type: 'textarea',
            ...
            { name: 'involvePrimaryLabel', type: 'text', defaultValue: 'Make a Donation' },
            { name: 'involvePrimaryUrl', type: 'text', defaultValue: '/donate' },
            { name: 'involveSecondaryLabel', type: 'text', defaultValue: 'Get in Touch' },
            { name: 'involveSecondaryUrl', type: 'text', defaultValue: '/contact' },
          ],
        },
        {
          type: 'collapsible',
