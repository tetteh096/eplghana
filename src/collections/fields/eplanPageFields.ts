    ...
    fields: [
      ...
      },
      {
        ...
        fields: [
          ...
          { name: 'sustainImage', type: 'upload', relationTo: 'media' },
          { name: 'sustainImageAlt', type: 'text', defaultValue: d.sustain.imageAlt },
          { name: 'sustainPillarsEyebrow', type: 'text', defaultValue: d.sustain.pillarsEyebrow },
          {
            name: 'sustainPillars',
            type: 'array',
      ...
      },
      {
        ...
        fields: [
          ...
          { name: 'spotlightIntro', type: 'textarea', defaultValue: d.spotlight.intro },
          {
            ...
            defaultValue: d.spotlight.items,
            fields: [
      ...
      },
      {
        ...
        fields: [
          ...
          { name: 'newsReadMoreLabel', type: 'text', defaultValue: d.news.readMoreLabel },
          {
            name: 'newsItems',
            type: 'array',
