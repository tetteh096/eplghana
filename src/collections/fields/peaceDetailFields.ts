...
export const peaceDetailFields: Field[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'keySuccessTitle', type: 'text', defaultValue: d.keySuccess.title },
      {
  ...
  },
  {
    ...
    fields: [
      { name: 'relatedArticlesEyebrow', type: 'text', defaultValue: d.relatedArticles.eyebrow },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'partnerDescription', type: 'textarea', defaultValue: d.partnerCta.description },
