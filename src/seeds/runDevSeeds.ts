...
import { seedDonatePage } from './tasks/donatePage'
import { seedEplanPage } from './tasks/eplanPage'
import { seedGalleryAlbums } from './tasks/galleryAlbums'
import { seedGalleryPage } from './tasks/galleryPage'
...
const contentTasks: DevSeedTask[] = [
  ...
  { name: 'donate-page', run: seedDonatePage },
  { name: 'partners-page', run: seedPartnersPage },
  { name: 'eplan-page', run: seedEplanPage },
  { name: 'gallery-page', run: seedGalleryPage },
  { name: 'gallery-albums', run: seedGalleryAlbums },
