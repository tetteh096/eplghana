...
export function ChariticsWotrDetail({
  ...
  return (
    <>
          ...
          <div className="row ul-bs-row gy-5 align-items-center">
            <div className="col-lg-5">
              <div className="epl-wotr-hero-copy">
                ...
                <ul className="epl-wotr-hero-stats">
      ...
      <section className="epl-wotr-why ul-section-spacing">
        <div className="ul-container">
          <SectionHead centered eyebrow={whyItMatters.eyebrow} title={whyItMatters.title} />
          <div className="epl-wotr-why-grid">
            {whyItMatters.items.map((item) => (
              <article className="epl-wotr-why-card" key={item.title}>
                <div className="epl-wotr-why-icon">
                  <i aria-hidden className={item.icon}></i>
                </div>
                <h3 className="epl-wotr-why-title">{item.title}</h3>
                <p className="epl-wotr-why-descr">{item.description}</p>
              </article>
            ))}
          </div>
        </div>
      ...
      <section className="epl-wotr-outcomes ul-section-spacing">
        <div className="ul-container">
          <SectionHead eyebrow={outcomes.eyebrow} title={outcomes.title} />
      ...
      <section className="epl-wotr-gallery ul-section-spacing">
        <div className="ul-container">
          <SectionHead centered eyebrow={gallery.eyebrow} title={gallery.title} />
      ...
      <section className="epl-wotr-involved-cta">
        <div className="ul-container">
          <div className="epl-wotr-involved-cta-inner">
            <div className="epl-wotr-involved-cta-copy">
              <span className="epl-wotr-involved-cta-eyebrow">{getInvolvedCta.eyebrow}</span>
              <h2 className="epl-wotr-involved-cta-title">{getInvolvedCta.title}</h2>
              <p className="epl-wotr-involved-cta-descr">{getInvolvedCta.description}</p>
              <div className="epl-wotr-involved-cta-actions">
                <Link className="ul-btn epl-wotr-involved-cta-btn" href={getInvolvedCta.ctaHref}>
                  <i className="flaticon-fast-forward-double-right-arrows-symbol"></i>{' '}
                  {getInvolvedCta.ctaLabel}
                </Link>
                <Link className="epl-wotr-involved-cta-link" href={getInvolvedCta.secondaryCtaHref}>
                  {getInvolvedCta.secondaryCtaLabel} <i className="flaticon-up-right-arrow"></i>
                </Link>
              </div>
            </div>
          </div>
